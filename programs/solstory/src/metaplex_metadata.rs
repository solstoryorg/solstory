/*
 *
 * This is a HACK anchor binded version of the metaplex token program state.rs taken
 * Jan 4, likely valid for metaplex 1.0 and 1.1.
 *
 * But possibly not we'll see if it causes errors wee!
 */
